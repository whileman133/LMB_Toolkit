...
%   U0, X, and omega column vectors; the order of the gallery
%   potentials U0 is garenteed to remain the same after the optimization
lb.U0 = 3;         ub.U0 = 5;
lb.X  = 0.1;       ub.X  = 0.4;
lb.omega = 0.1;    ub.omega = 10;
lb.thetamin = 0;   ub.thetamin = 0.2;
lb.thetamax = 0.9; ub.thetamax = 1.0;
% [U0g,Xg,omegag]=inspectMSMR(ocp,J);
% return;
