...
% programmatically generating and running COMSOL simulations of the
% full-order LPM for LMB.
%
...
% structure has fields for each region of the cell (neg,DL,sep,pos) as well
% as constants (const).
...
% Now, cellModelSetpoint1.neg, ".DL, ".sep, ".pos, ".const are structures
