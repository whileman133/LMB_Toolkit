% testLayerReductionHypothesis_LargeW.m
%
% -- Changelog --
...
plotdir = fullfile('plots','layer-reduction-hypothesis-lg-W');
W = 2;
freq = logspace(-3.5,5,100);   % Frequency points to evalulate in the spectrum [Hz].
...
for n = 1:length(tfReduced)
    ...
    annotation('textbox',[0.16, 0.5, 0.175, 0.15], ...
        'String', ...
            [sprintf('RMSE\n') ...
             sprintf('$%.2f\\,\\mathrm{m\\Omega}$ $|Z|$\n',1000*magRMSE) ...
             sprintf('$%.2f^\\circ$ $\\angle Z$',phsRMSE)], ...
        'Interpreter','latex','BackgroundColor','w','FontSize',15);
    setAxesNyquist;
    thesisFormat;
