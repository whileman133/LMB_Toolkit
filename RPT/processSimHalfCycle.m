...
halfcycArg = [halfcycData.arg];
Z0 = [halfcycArg.z0].';  % initial SOC [fractional]
...
hcycData.ocp.Uocp = UcopEst;
hcycData.ocp.TdegC = simData.TdegC;
% Remove NaNs from dc resistance estimate!
hcycData.res.socAvgPct = zavg(~isnan(RdcEst));
hcycData.res.Rdc = RdcEst(~isnan(RdcEst));
