% plotCompareROM_Lab_HalfCycleDischarge.m
...
% Constants ---------------------------------------------------------------
romFilename = '202310_EIS-16degC26degC-Ds=linear-k0=linear_defaultHRA';
labDirectory = fullfile(TB.const.RPTROOT,'labdata');
labFilename = 'HALFCYCLE_DISCHARGE';
TdegC = 25;

% Collect lab data --------------------------------------------------------
file = fullfile(labDirectory,[labFilename '.DTA']);
